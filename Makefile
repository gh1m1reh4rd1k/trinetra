...
SRCS := scan.cpp main.cpp utils.cpp public_db.cpp anomaly_analysis.cpp probe.cpp control.cpp async_io.cpp netns_split.cpp traceroute.cpp parser.cpp handler.cpp arp_handler.cpp debug.cpp dns_enum.cpp server.cpp ssl_enum.cpp simulations.cpp net_capture.cpp discover.cpp
OBJ_DIR := object
TARGET := shiv
